...
def main() -> None:
    ...
    plot_parser.add_argument("--files", nargs="*", default=["results/LAHC.json", "results/SPEA-II.json", "results/COMPETITION.json", "results/GREEDY.json"], 
                             help="JSON result files")

    rank_parser = subparsers.add_parser("rank", help="Perform weighted ranking")
    rank_parser.add_argument("--files", nargs="*", default=["results/LAHC.json", "results/SPEA-II.json", "results/COMPETITION.json", "results/GREEDY.json"], 
                             help="JSON result files")
