...
def main() -> None:
    ...
    if args.command == "run":
        available_algorithms = {
            ...
            "SPEA-II": lambda: SPEA2Solver(pop_size=378,archive_size=110,max_generations=5000,mutation_rate=0.03663189655760893,mutation_limit=40,nuke_limit=70,TABU_THRESHOLD=20,TABU_DURATION=15),
